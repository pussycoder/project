...
final class ProductsController extends AbstractController
{
    ...
    public function index(ProductsRepository $productsRepository): Response
    {
        ...
        // Admin + staff can see all products
    ...
    public function edit(
        ...
        // Staff can edit/update only products created by admin
        if (!$this->isGranted('ROLE_ADMIN')) {
            $createdBy = $product->getCreatedBy();
            $creatorRoles = $createdBy ? $createdBy->getRoles() : [];
            if (!in_array('ROLE_ADMIN', $creatorRoles, true)) {
                throw $this->createAccessDeniedException('Staff can only edit products created by admin.');
            }
        }
